...
public class ProductoService extends BaseService<Producto, Long, ProductoRepository>{
	 ...
	 * @param p el producto con los atributos menos la imagen
	 * @param file este archivo es la imagen
	 */
	 ...
	 * @param pageable hace que sea paginable el findall
	 ...
	 * @param nombre nombre buscado
	 * @param pageable hace que sea paginable el resultado
